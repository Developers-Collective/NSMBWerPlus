SECTIONS {
	exeFrame__10dScStage_c = 0x80429F20;

	getMissSpinAngle__7dAcPy_cFv = 0x80129720;
	dropObject__7dAcPy_cFP13dStageActor_c = 0x8012E320;
	setRide__5dRc_cFP13BasicCollider = 0x800D9870;
	FUN_80a1a650 = 0x80A19F70;
	FUN_80a1a1e0 = 0x80A19B00;
	FUN_80a1a320 = 0x80A19C40;
	FUN_80080dc0 = 0x80080DC0;
	FUN_80080de0 = 0x80080DE0;
	FUN_80080e00 = 0x80080E00;
	switchOnCreate = 0x80A190D0;
	iceSetSpinLiftUpActor = 0x80121BC0;
	StateID_CarryUp__13daEnJumpdai_c = 0x80B16A38;
	StateID_Move__13daEnJumpdai_c = 0x80B169F8;
	StateID_Wait__13daEnHnSwich_c = 0x80B15668;
	StateID_PushWait__13daEnHnSwich_c = 0x80B15768;
	StateID_Carry__13dEnemyCarry_c = 0x803578B4;
	getCarryPos__7dAcPy_cFP7Point3dP7dAcPy_c = 0x8012DC90;

	returnFromCrowEffects5 = 0x809EE65C;

	aKinopio = 0x80427938;
	aK_rcha = 0x80427940;
	aKb_model = 0x80315AB8;
	aSkb_model = 0x80315AC4;
	aPlkb_model = 0x80315AD0;
	aPkb_model = 0x80315ADC;
	aKh_model = 0x80315AE8;
	aSkh_model = 0x80315AF4;
	aPlkh_model = 0x80315B00;
	aPkh_model = 0x80315B0C;
	ToadModelInfo = 0x802F0BA0;

	isNoDamage__7dAcPy_cFv = 0x80145E70;
	setDamage__7dAcPy_cFP8dActor_ci = 0x80145F00;
	...
	instance__11dScoreMng_c = 0x80429D70;
	sub_800E2190__11dScoreMng_cFP5dEn_cffii = 0x800E2020;
	instance__11dMultiMng_c = 0x80429CD0;
	incEnemyDown__11dMultiMng_cFUi = 0x800CE9A0;
	getPlrNo__13dStageActor_cFv = 0x8001D200;


	origFireSnakeIceballCollision = 0x809FAD30;

	doneWithChangeRemoconID = 0x8005316C;
	doneWithChangeRemoconID2 = 0x80144E30;
	CreateObject__Fsic = 0x80162930;
	onCreate_orig__13dScWorldMap_cFv = 0x80927310;

	isPartialBlockOrBlockSolidAtPos__14collisionMgr_cFffUc = 0x80070B10;

	returnFromFrogPenguinMove1 = 0x80A29764;
	returnFromFrogPenguinMove2 = 0x80A27498;
	...
	endStar__7dAcPy_cFv = 0x80145A60;

	returnFromSelectCorrectPlayerAnimation1 = 0x808C59AC;
	returnFromSelectCorrectPlayerAnimation2 = 0x808C6560;
	returnFromSelectCorrectPlayerAnimation3 = 0x808C5F00;

	StateID_Wait__10daEnItem_c = 0x80B15FB8;
	AddPhysics__10daEnItem_cFv = 0x80A284B0;

	returnTodPlayerMdl_c__playFix = 0x800D38C4;
	setSoftLight__18dPlayerModelBase_cFPQ23m3d5mdl_c = 0x800D5B10;
	dPlayerMdl_c__createPlayerModel = 0x800D3304;

	returnToFooCloud = 0x809DD030;
	StateID_IceDamage__10daPlBase_c = 0x803761F0;
	returnToAfterIceBallSound = 0x807D4E44;
	returnToStartIceBallSound = 0x807D4E34;

	FUN_8085f5c0 = 0x8085F360;
	fixJumbo1return = 0x8085FE14;
	fixJumbo2return	= 0x808600d8;

	IOS_OpenAsync = 0x80224960;

	AXSetMasterVolume = 0x801A1700;

	returnFromBlooperNanny = 0x809A884C;
	returnFromTEX_BoomerangSettings = 0x809CDD78;
	returnFromTEX_HammerSettings = 0x80A11D14;
	returnFromPakkun_Projectile = 0x80029644;
	returnFromLakituSpawnArea = 0x80ABC46C;
	returnFromLakituCloudBlock = 0x80A359B4;

	/* The Prankster Comets */

	doneWithAddSettingsBMG = 0x8077AB58;
	TextBoxSetBmgString = 0x800C99E0;

	CSMWindow = 0x80940F08;
	CSMButton1 = 0x80940F14;
	CSMButton2 = 0x80940F20;
	CSMButton3 = 0x80940F2C;
	CSMButton4 = 0x80940F38;
	doneWithChangeGroupNames = 0x8077AB00;

	P_SBBase_01 = 0x80940F90;
	P_SBBase_02 = 0x80940F9C;
	P_SBBase_03 = 0x80940FA8;
	P_SBBase_04 = 0x80940FB4;
	P_back = 0x80940FC0;
	P_backWhite = 0x80940FC8;
	doneWithChangePicturePaneNames = 0x8077AB20;

	doneWithChangeSelectCursorStuff = 0x8077ACA0;

	doneWithChangeMenuResults = 0x8092F9A8;
	doneWithChangeMenuResults2 = 0x8092FAB0;

	doneWithSpawnSettingsActor = 0x80926DCC;

	changeToNormalState__22dCourseSelectManager_cFv = 0x8092F3B0;


	doneWithAddSignFlag = 0x800F4584;

	doneWithSpawnStarSign = 0x808E1678;
	doneWithSpawnStarSign2 = 0x808E169C;
	doneWithSpawnStarSign3 = 0x808E16FC;
	AndR5WithNodeR4Props = 0x800F5720;
	SpawnWorldmapObject = 0x800F2970;

	sub_801007D0 = 0x80100640;
	doneWithPreserveR5 = 0x808E15CC;

	doneWithLoadStarSign = 0x80926810;

	doneWithDoSomeCheating4 = 0x808C9E30;

	doneWithDoSomeCheating5 = 0x808C9A78;

	GetPositionOfWorldmapBone = 0x80100660;

	doneWithCSMgrCheckForSignByte = 0x8092F73C;
	doneWithCSMgrCheckForSignByte2 = 0x8092F8B8;

	doneWithDoW8Checks = 0x80907A9C;
	doneWithDoW8Checks2 = 0x80907B00;
	AndR5WithNodeR4Props = 0x800F5720;
	...
	onExecute_orig__13daObjCenter_cFv = 0x80874270;
	doneWithTowerBlockSpeed = 0x800D737C;
	doneWithTowerBlockDelay = 0x800D7344;
	doneWithCenterSpeed1 = 0x80874308;
	doneWithCenterSpeed2 = 0x80874354;
	doneWithCenterSpeed3 = 0x8087438C;
	doneWithDryBonesUpdateRate = 0x80A42384;
	...
	doneWithDoubleCanonSpeed = 0x80A4DE88;
	doneWithDoubleBulletSpeed = 0x80A4901C;
	doneWithDoubleSpeedToPos = 0x8006CD44;

	mazeAutoscrollSpeed = 0x8042BAB8;
	...
	doneWithDoublePlatformSpeed = 0x800C0248;

	onExecute__17daEnDpakkunBase_cFv = 0x8002CE30;
	doneWithDoublePakkunSpeed2 = 0x8002CF68;

	doneWithDoubleFbaseSpeed3 = 0x80161B24;

	processOperation_fBase_c = 0x80161AD0;
	...
	SetAltSeed__9dRandom_cFUi = 0x80161190;

	doesFunStuffsWithClr__14dPlayerModel_cFPQ23m3d5mdl_cUi = 0x800D4A50;

	IOS_Open__FPci = 0x80224A80;
	IOS_Close__Fi = 0x80224C70;
	IOS_Ioctl__FiiPvUlPvUli = 0x80225450;
	IOS_Ioctlv__FiiiiPv = 0x802257B0;
	IOS_Ioctl__FiiPvUlPvUl = 0x80225450;

	toadBlockEditsReturn = 0x809C2954;
	checkToadBlockNoToadReturn = 0x809C330C;
	player_set_15daEnBlockMain_cFii = 0x80022080;
	FUN_P1_800fd140 = 0x800FCFB0;

	StateID_Move__12daEnTeresa_c = 0x80B1B188;
	getTargetPos__12daEnTeresa_cFP7Point2d = 0x80AAF860;
	origOnExecute__12daEnTeresa_cFv = 0x80AAE440;
	origOnCreate__12daEnTeresa_cFv = 0x80AAE1B0;
	...
	returnFromEggAddNewPowerups = 0x809114E0;
	returnFromChangeRedRingArray = 0x80A93B9C;

	returnToBigUrchinFireballReal = 0x80AB8DF0;
	continueForNormalUrchinFireball = 0x80AB8DC0;
	returnToBigUrchinIceballReal = 0x80AB8E90;
	continueForNormalUrchinIceball = 0x80AB8E88;
	returnForMawRayStar = 0x80AB8D00;
	continueForNormalUrchinStar = 0x80AB8CD8;
	continueUrchinTurn = 0x80AB89DC;
	continueUrchinNoTurn = 0x80AB89E0;
	continueUrchinOnCreate = 0x80AB8868;
	StateID_Wait__12daEnUnizoo_c = 0x80B1B6F8;
	getAngleOfSlopeInDirection__14collisionMgr_cFi = 0x800708C0;
	getAngleOfSlopeWithXSpeed__14collisionMgr_cFf = 0x80070900;

	callFooDeath = 0x80A6AD30;

	yoshiEatCheck = 0x8014F3A0;
	yoshiSetEatAction = 0x8014EC20;
	yoshiFinalizeEat = 0x8014F010;

	returnFromGetLavaWavesSubType = 0x80075524;
	returnFromSaveLiquidSettings = 0x807B4AD4;
	continueBGpolyCreate = 0x807B4AB4;
	returnFromSelectDifferentLiquidsSet = 0x800EB01C;
	returnFromSelectDifferentLiquidsSet2 = 0x800EBCF4;
	dWaterManager_c__add = 0x800EB540;
	returnFromSaveLiquiSubTypesInNewArray = 0x807B4DCC;
	returnFromUseDifferentSplashEffects = 0x80092128;
	returnFromSelectDifferentLavaDeco = 0x800EBD24;
	doneWithLavaParticlesColor = 0x80888A78;
	continueOriginalCheckWater = 0x80075274;
	returnFromSaveGlobalWaterSubType = 0x807B56F4;
	returnFromSaveGlobalLavaSubType = 0x807B579C;
	returnFromSaveGlobalPoisonSubType = 0x807B5830;
	returnFromLoadGlobalSubType = 0x80075524;
	returnFromPlayerUsePoisonSplashSubType = 0x8013D984;
	returnFromPlayerUseLavaSplashSubType = 0x8013DEC8;
	returnFromUseDifferentSplashEffects2 = 0x800920F0;
	returnFromIceUseLavaSplashSubType = 0x8011F2CC;
	returnFromIceUsePoisonSplashSubType = 0x80121DD8;
	returnFromPodobooUseLavaSplashSetting = 0x809D12E0;
	FUN_8008fba0__FiPQ23mEf3es2PcUiP7Point3dUiPf = 0x8008FBA0;
	FUN_8008fb60__FiPcUiP7Point3dP6S16VecP7Point3d = 0x8008FB60;

	obj_waterfull = 0x8031B248;
	obj_waterhalf = 0x8031B260;
	obj_magma = 0x8031B278;
	obj_poisonwater = 0x8031B28C;
	obj_quicksand = 0x8031B2A8;
	obj_envfog = 0x8031B2C0;
	obj_magmawave = 0x8031B460;
	obj_magmadeco = 0x8031B620;

	aWm_en_waterwav = 0x80311350;
	aWm_en_cmnwat_0 = 0x80311364;
	aWm_en_waterspl = 0x80311374;
	aWm_en_firevani = 0x80311388;
	aWm_en_cmnmag_1 = 0x8031139C;
	aWm_en_magmaw_0 = 0x803113B0;
	aWm_en_poisonin = 0x803113C0;
	aWm_en_poisonwa = 0x803113D4;

	returnFromToadBalloon_TextColor = 0x80A0E530;
	FUN_800b34d0 = 0x800B34D0;
	toadColorAddress = 0x80429930;

	stockItemPowerupModelScale = 0x8093C37C;
	stockItemPlayerModelScale = 0x8093BE34;

	returnFromCheckWarpCannon1 = 0x80102408;
	returnFromCheckWarpCannon2 = 0x801023E8;
	returnFromDontResetLevelNode = 0x8092738C;

	returnFromWindColor = 0x80887CE0;

	returnFromWaterMultiplier = 0x801319E8;
	returnFromWaterMultiplier2 = 0x80131BB4;
	returnFromWaterMultiplier3 = 0x801310E0;
	...
	returnToOriginalAnimationCode3 = 0x80906328;
	returnToOriginalAnimationCode4 = 0x8090631C;

	check_GROUP_CASTLE = 0x800F9804;
	return_after_GROUP_BOSS_script = 0x80904450;
	not_GROUP_BOSS_script = 0x809041D8;

	getNodeWorldMtxMultVecZero__Q23m3d5mdl_cFUiP7Point3d = 0x80168040;

	returnFromShellTest = 0x80146EA8;

	FUN_80a28e00 = 0x80A28720;
	FUN_80a28d10 = 0x80A28630;
	FUN_80a29110 = 0x80A28A30;
	FUN_80a286c0 = 0x80A27FE0;
	...
	daEnKanon_c__StateID_Walk = 0x80B16E88;
	daEnKanon_c__StateID_Turn = 0x80B16EC8;
	daEnKanon_c__StateID_Damage = 0x80B16F48;

	/*beginState_StarMove__12daDarkStar_cFv = 0x80A29B70;
	executeState_StarMove__12daDarkStar_cFv = 0x80A29C00;
	endState_StarMove__12daDarkStar_cFv = 0x80A29BF0;*/
	checksSomething__13dStageActor_cFv = 0x80065110;
	EnItem_GetZPosToUse = 0x80A282E0;
	checkLiquidImmersionAndKillIfTouchingLava__5dEn_cFP7Point3df = 0x80097170;

	UpdateSelectCursor = 0x800B44D0;
	returnToCoin = 0x80783BCC;
	returnToMulti = 0x80783BE0;
	returnFromNewButtons = 0x80783C64;
	returnFromNewButtons2 = 0x80783BAC;
	returnFromNewButtons3 = 0x80783B80;

	returnTo80783C4C = 0x80783B5C;
	returnTo80783CE8 = 0x80783BF8;

	returnFromSandpillar = 0x80801ED8;
	returnFromWaterwaveIn1 = 0x80803138;
	returnFromWaterwaveIn2 = 0x808036C0;
	returnFromWaterwaveIn3 = 0x808032B4;

	returnFromWaterwaveOut1 = 0x80803694;
	returnFromWaterwaveOut2 = 0x80803288;
	returnFromWaterwaveOut3 = 0x8080310C;

	returnFromWatersplash1 = 0x80802EBC;
	returnFromWatersplash2 = 0x80802CB8;

	returnFromWater021 = 0x808032E8;
	returnFromWater022 = 0x808030A0;
	returnFromWater023 = 0x80802F0C;

	returnFromFloatSplash = 0x808024A4;

	returnFromNoEffectWalking = 0x80801E18;

	daPyDemoMng_c__instance = 0x804299B4;

	onCreate_orig__14dCourseClear_cFv = 0x80779A40;

	returnArrowSignboard = 0x8081C6F4;
	returnBooCircle = 0x8089FD04;

	ContinueFromSixteenthHook = 0x80143370;

	layerZPositionForByugoHack = 0x8042B674;

	continueNodeSetup = 0x808E7EF0;
	...
	StateID_DemoInWaterTank__10daPlBase_c = 0x803547EC;
	...
	continueIsWXS1 = 0x808E7F10;
	continueWithPat0SetupFromWXS0 = 0x808E7F00;
	LAB_808e81d4 = 0x808E7F24;
	...
	it_is_right = 0x807B0DC0;
	not_right = 0x807B0DD4;
	it_is_right2 = 0x807B1014;
	not_right2 = 0x807B1028;
	dStockItem__manipulateItemID = 0x807B0680;
	tryAndMoveRight = 0x807B06F0;
	tryAndMoveLeft = 0x807B06B4;
	cantChange = 0x807B06FC;
	continueRightLoop = 0x807B06DC;
	continueLeftLoop = 0x807B06A0;
	...
	returnForCalledFromExecute = 0x808FBA38;
	continueInCalledFromExecute = 0x808FB064;
	continueAt80904158 = 0x80903EA8;
	continueAt8090415C = 0x80903EAC;
	LAB_809042ec = 0x8090403C;
	FUN_808fbd00 = 0x808FBA50;
	FUN_808fbd10 = 0x808FBA60;

	aLightMainscene = 0x8098CE40;
	aLightChikascen = 0x8098CE58;
	aLightWaterscen = 0x8098CE70;
	aLightFirescene = 0x8098CE88;
	aLightSabakusce = 0x8098CEA0;
	aLightKaigansce = 0x8098CEBC;
	aLightDaishizen = 0x8098CED8;
	aLightYukidaysc = 0x8098CEF4;
	aLightSorascene = 0x8098CF10;
	aLightIwabascen = 0x8098CF28;
	aLightToridesce = 0x8098CF40;
	aLightShiroscen = 0x8098CF60;
	aLightObakescen = 0x8098CF78;
	aLightKurayamic = 0x8098CF90;
	aLightObakeouts = 0x8098CFB0;
	aLightShinkaisc = 0x8098CFCC;
	aLightSabakuchi = 0x8098CFE8;
	aLightKorichika = 0x8098D008;
	aLightFire2scen = 0x8098D028;
	aLightKoopascen = 0x8098D040;
	aLightFire3scen = 0x8098D058;
	aLightKumorisor = 0x8098D070;
	aLightToride2sc = 0x8098D090;

	aLightMainsce_0 = 0x8098D0AC;
	aLightChikasc_0 = 0x8098D0C4;
	aLightWatersc_0 = 0x8098D0DC;
	aLightFiresce_0 = 0x8098D0F4;
	aLightSabakus_0 = 0x8098D110;
	aLightKaigans_0 = 0x8098D128;
	aLightDaishiz_0 = 0x8098D140;
	aLightYukiday_0 = 0x8098D15C;
	aLightSorasce_0 = 0x8098D178;
	aLightIwabasc_0 = 0x8098D190;
	aLightTorides_0 = 0x8098D1A8;
	aLightShirosc_0 = 0x8098D1C0;
	aLightObakesc_0 = 0x8098D1D8;
	aLightKurayam_0 = 0x8098D1F0;
	aLightObakeou_0 = 0x8098D210;
	aLightShinkai_0 = 0x8098D22C;
	aLightSabakuc_0 = 0x8098D248;
	aLightKorichi_0 = 0x8098D268;
	aLightFire2sc_0 = 0x8098D284;
	aLightKoopasc_0 = 0x8098D29C;
	aLightFire3sc_0 = 0x8098D2B4;
	aLightKumoris_0 = 0x8098D2CC;
	aLightToride2_0 = 0x8098D2E8;

	aFogMainscene_b = 0x8098D304;
	aFogChikascene_ = 0x8098D318;
	aFogWaterscene_ = 0x8098D32C;
	aFogFirescene_b = 0x8098D340;
	aFogSabakuscene = 0x8098D354;
	aFogKaiganscene = 0x8098D36C;
	aFogDaishizensc = 0x8098D388;
	aFogYukidayscen = 0x8098D3A0;
	aFogSorascene_b = 0x8098D3B8;
	aFogIwabascene_ = 0x8098D3CC;
	aFogToridescene = 0x8098D3E0;
	aFogShiroscene_ = 0x8098D3F8;
	aFogObakescene_ = 0x8098D40C;
	aFogKurayamichi = 0x8098D420;
	aFogObakeoutsce = 0x8098D43C;
	aFogShinkaiscen = 0x8098D454;
	aFogSabakuchika = 0x8098D46C;
	aFogKorichikasc = 0x8098D488;
	aFogFire2scene_ = 0x8098D4A0;
	aFogKoopascene_ = 0x8098D4B4;
	aFogFire3scene_ = 0x8098D4C8;
	aFogKumorisoras = 0x8098D4DC;
	aFogToride2scen = 0x8098D4F8;


	aRouteinfo_1 = 0x8098D67C;
	aCollectioncoincoursesort = 0x8098D688;
	aCobcastle_1 = 0x8098D6A4;
	aCobcourse_0 = 0x8098D6B0;
	aCobkinokored_3 = 0x8098D590;
	aCobkinoko1up_4 = 0x8098D5A0;
	aCobkinokosta_3 = 0x8098D5B0;
	aCobstart_0 = 0x8098D6BC;
	aCobanchor_0 = 0x8098D6C8;
	aCobtoride_1 = 0x8098D6D4;
	aCobghost_1 = 0x8098D6E0;
	aCobcannon_1 = 0x8098D6EC;
	aCobkoopaship_5 = 0x8098D5C0;
	aCharacter_s_12 = 0x8098D6F8;
	aCobsurrender_0 = 0x8098D708;
	aCobkinopio_1 = 0x8098D718;
	create__8dActor_cF6ActorsUiP7Point3dPv = 0x8006CA80;

	returnToOriginalScriptCode = 0x8010153C;

	destroyBarrel = 0x807C1B60; /* extern "C" void destroyBarrel(dStageActor_c *); */

	StateID_FoolMove__14daEnGakeNoko_c = 0x80B144E0;
	StateID_Move__14daEnGakeNoko_c = 0x80B14520;
	...
	dEventOpeningTitle_c_StateID_PressButtonExitAnimeEndWait = 0x80991810;

	sub_809CAE10 = 0x809CA730;

	loc_8091288C = 0x809125DC;
	...
	ContinueFromEleventhHook = 0x809264C4;
	ContinueFromTwelvethHook = 0x8006F7B8;
	ContinueFromThirteenthHook = 0x80064F54;
	ContinueFromFourteenthHook = 0x80070CC4;

	/* effectvideo.cpp */
	LoadBreffKoopa = 0x809200A0;
	LoadBreffKoopaJr = 0x80920094;
	returnFromBreffLoadPatch = 0x8091FF40;
	...
	/* daYoshiFire_c */
	daYoshiFire_c_vf8C__FP13dStageActor_cP13dStageActor_c = 0x80912700;
	...
	ContinueFromLoadingCRSIN = 0x8091E9C8;
	...
	onCreate_orig__10daEnNoko_cFv = 0x80A71F10;
	...
	onExecute_orig__10daEnPata_cFv = 0x80A72500;

	onCreate_orig__10BulletBillFv = 0x80A48D60;
	playerCollision_orig__10BulletBillFP13ActivePhysicsP13ActivePhysics = 0x80A49690;
	addScoreWhenHit_orig__10BulletBillFPv = 0x80A49B30;
	ContinueFromSpikyFix = 0x80A4C970;
	...
	dStockItem = 0x807AF4D0;

	playBoomerangSound__16daBoomerangHax_cFv = 0x807C7610;
	pow = 0x802E53B4;
	onExecute_orig__14dGameDisplay_cFv = 0x80157DA0;
	onCreate_orig__14dGameDisplay_cFv = 0x80157840;
	instance__14dGameDisplay_c = 0x8042A048;
	onCreate_orig__13daGabonRock_cFv = 0x807F8930;
	onCreate_orig__12EN_STAR_COINFv = 0x80AA9160;

	onCreate_orig__12daEnBomhei_cFv = 0x809C8750;
	StateID_Sleep__12daEnBomhei_c = 0x80B123A8;
	playerCollision_orig__12daEnBomhei_cFP13ActivePhysicsP13ActivePhysics = 0x809C92E0;
	spriteCollision_orig__12daEnBomhei_cFP13ActivePhysicsP13ActivePhysics = 0x809C9910;
...
/* Mr Sun Related */
	...
	/* spinningPhysicsCallback__7Physics = 0x808A2120; */
	...
	GetParent__7fBase_cFv = 0x801623A0;
	OSReport = 0x8015F540;
	...
	memcmp__FPCvPCvUl = 0x802DEEA8;
	memcmp__FPCvPCvUi = 0x802DEEA8;
	free__FPv = 0x802DD670;
	_Z6strcatPKcS0_ = 0x802E184C;
	...
	__vt__Q23m3d12anmChrPart_c = 0x80303210;
	__dt__Q23m3d12anmChrPart_cFv = 0x80028370;
	vf0C__Q23m3d12anmChrPart_cFv = 0x8002A200;
	attachChr__Q23m3d12anmChrPart_cFUiQ23m3d8anmChr_cf = 0x801654D0;
	setup__Q23m3d12anmChrPart_cFQ34nw4r3g3d6ResMdlUiP12mAllocator_cPUi = 0x80165330;
	...
	getFrameForEntry__Q23m3d8anmClr_cFi = 0x801660F0;
	...
	isEntryAnimationDone__Q23m3d11anmTexPat_cFi = 0x80166D30;
	...
	Pa1Daishizen = 0x80971F64;
	returnFromFlowerBuild1 = 0x8087608C;
	returnFromFlowerBuild2 = 0x808763F4;
	returnFromFlowerBuild2ItsGrassland = 0x8087610C;
	returnFromFlowerBuild2ItsDaishizen = 0x80876128;
	returnFromFlowerBuild3 = 0x808761A4;
	returnFromFlowerBuild3ItsGrassland = 0x80876170;
	returnFromFlowerBuild3ItsDaishizen = 0x8087618C;
	returnFromFlowerBuild4 = 0x80876320;
	ObjHana = 0x80971F88;
	ObjKusa = 0x80972010;
	ObjKusaBrres = 0x80971FFC;

	returnFromAirshipCloudsNotGood = 0x809DD754;
	returnFromAirshipCloudsIsGood = 0x809DD748;
	...
	orig_wm_build = 0x809886D4;


	SI_Kinoko = 0x8098D95C;
	SI_Fireflower = 0x8098D968;
	SI_Propeller = 0x8098D978;
	SI_Iceflower = 0x8098D988;
	SI_Penguin = 0x8098D998;
	SI_Star = 0x8098D9A8;

	aSi_kinoko_0 = 0x8098D95C;
	aSi_fireflowe_0 = 0x8098D968;
	aSi_propeller_0 = 0x8098D978;
	aSi_iceflower_0 = 0x8098D988;
	aSi_penguin_0 = 0x8098D998;
	aSi_star_0 = 0x8098D9A8;

	aSi_kinoko = 0x80982C5C;
	aSi_fireflower = 0x80982C68;
	aSi_propeller = 0x80982C78;
	aSi_iceflower = 0x80982C88;
	aSi_penguin = 0x80982C98;
	aSi_kinoko = 0x80982C5C;
	aSi_star = 0x80982CA8;

	aI_kinoko_6 = 0x80982BC8;
	aI_fireflower_1 = 0x80982BD4;
	aI_propeller_4 = 0x80982BE4;
	aI_iceflower_4 = 0x80982BF0;
	aI_penguin_4 = 0x80982AFC;
	aI_kinoko_6 = 0x80982BC8;
	aI_star_4 = 0x80982C08;
	aI_propeller_model_2 = 0x80982C2C;

	goToSpecificWorld__Fcc = 0x80102610;
	AssembleScWorldMapSettings__FUcii = 0x801029E0;
	DoShitWithWMPlayer__Fi = 0x809072E0;

	beginState_Shoot__Fi = 0x808BCA20;
	...
	/*
	daEnGakeNoko_c__StateID_FoolMove = 0x80B144E0;
	dAcPy_c__ChangePowerupWithAnimation = 0x801458D0;
	daEnItem_c__GetWhetherPlayerCanGetPowerupOrNot = 0x80A2B780;
	...
	*/
	...
	DoGoldFromProjectileShootCheck_Fix = 0x8013B824;

	//__ct__16daGoldFireBall_cFv = 0x8011A280;
	__dt__16daGoldFireBall_cFv = 0x8011AD80;
	onCreate_orig__16daGoldFireBall_cFv = 0x80040960;
	onExecute_orig__16daGoldFireBall_cFv = 0x80040BD0;
	onDelete__16daGoldFireBall_cFv = 0x8011A960;
	checkSomethingElseAboutCSensor__16daGoldFireBall_cFv = 0x8011AC90;
	CheckFireballLimit__16daGoldFireBall_cFv = 0x8011AD30;
	vf138__16daGoldFireBall_cFv = 0x8011A360;
	vf13C__16daGoldFireBall_cFv = 0x8011A370;

	updateSpawnLimits__16daGoldFireBall_cFv = 0x8011A380;
	calledInOnCreate_b__16daGoldFireBall_cFv = 0x8011A490;
	calledInOnCreate_c__16daGoldFireBall_cFv = 0x8011A5C0;
	setZOrder_maybe__16daGoldFireBall_cFv = 0x8011A400;
	doFireSplash__16daGoldFireBall_cFv = 0x8011A780;

	initialAdjacentCheck__16daGoldFireBall_cFv = 0x8011A610;
	theFuck__16daGoldFireBall_cFv = 0x8011A6C0;
	collisionCallback__16daGoldFireBall_cFP13ActivePhysicsP13ActivePhysics = 0x8011A860;
	checkSomethingAboutSlopesAndQuicksand__17daFireBall_Base_cFv = 0x8011ABA0;
	querySomethingByRCollDetector__17daFireBall_Base_cFv = 0x8011AC30;
	checkSomethingElseAboutCSensor__17daFireBall_Base_cFv = 0x8011AC90;
	setSpeed__17daFireBall_Base_cFv = 0x8011ACA0;
	CheckFireballLimit__17daFireBall_Base_cFv = 0x8011AD30;

	beginState_Move_orig__16daGoldFireBall_cFv = 0x8011A9C0;
	executeState_Move_orig__16daGoldFireBall_cFv = 0x8011A9E0;
	endState_Move_orig__16daGoldFireBall_cFv = 0x8011A9D0;
	...
	goldFireHitAdjacent = 0x8011AAD0;
	continueFromReplaceGoldHitSFXEnemy = 0x8011A920;
	...
	daEnSnakeBlock_c__StateID_Move = 0x80B1AD18;/*mi*/
	doSomethingElseWithTravelInfoBuffer__SnakeSubEx = 0x80AA6D00;/*mi*/
	continueFromFirstLoop = 0x80AA7530;
	continueFromNodeLoop = 0x80AA75A0;
	continueFromSnakeBlockLoop3 = 0x80AA6D74;
	continueFromSnakeBlockBackwards = 0x80AA6D24;
	continueFromStoreIsLoopToR9_1 = 0x80AA7EC0;
	continueFromStoreIsLoopToR9_2 = 0x80AA7ED0;
	continueFromOtherDirectionsSpawn = 0x80AA71BC;
	continueFromAdjustSpawnPosition = 0x80AA6858;
	continueFromRemoveSFX = 0x80AA7ED0;
	continueFromDoNotMoveIfEvent = 0x80AA6BE4;
	continueFromMakeTIBTwiceAsBig = 0x80AA7538;
	continueFromCreateBackwardsData = 0x80AA7A74;
	returnFromDoNotMoveIfEvent = 0x80AA6C00;
	skipFromRemoveSFX = 0x80AA7EFC;
	cancelNodeLoop = 0x80AA7A58;
	firstLoop = 0x80AA74E0;
	loopForNodes = 0x80AA754C;
	finishNodeLoop = 0x80AA7A58;
	abs = 0x802DE324;
	dRail__getRailByID_static = 0x800D9040;/*mi*/
	loc_80AA86FC = 0x80AA801C;
	doSomethingElseWithTravelInfoBuffer__10SnakeSubExFv = 0x80AA6D00;/*mi*/

	instance__22dCourseSelectManager_c = 0x809A1C90;
	StateID_KeyWait__22dCourseSelectManager_c = 0x809A1D60;
	StateID_StockItemSelectWait__22dCourseSelectManager_c = 0x809A1E20;
	sub_80931170__22dCourseSelectManager_cFv = 0x80930EC0;
	sub_809310F0__22dCourseSelectManager_cFv = 0x80930E40;
	sub_80931090__22dCourseSelectManager_cFv = 0x80930DE0;
	sub_80931110__22dCourseSelectManager_cFv = 0x80930E60;

	doneWithSpawnShopAndLevelCredits = 0x80926DCC;
	doneWithCheckForButtonPress = 0x80914954;
	doneWithCheckForNewCSMBytes = 0x8092F848;

	continueCheckForNewCSMBytes = 0x8092F830;

	returnCheckForNewCSMBytes = 0x8092F8B8;
