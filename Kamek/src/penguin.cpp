...
#include <stage.h>
#include <profile.h>
//no fucking clue if anybody even has the model for this, if it actually works, or what it was for, but gonna include it incase someone wants to restore it
const char* PengiArcNameList [] = {
	"penguin2",
	NULL	
};
