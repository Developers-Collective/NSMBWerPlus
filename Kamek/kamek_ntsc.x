SECTIONS {
	...
	FUN_80a1a650 = 0x80A1A670;
	FUN_80a1a1e0 = 0x80A1A200;
	FUN_80a1a320 = 0x80A1A340;
	FUN_80080dc0 = 0x80080DC0;
	FUN_80080de0 = 0x80080DE0;
	FUN_80080e00 = 0x80080E00;
	switchOnCreate = 0x80A197D0;
	iceSetSpinLiftUpActor = 0x80121DB0;
	StateID_CarryUp__13daEnJumpdai_c = 0x80B17138;
	StateID_Move__13daEnJumpdai_c = 0x80B170F8;
	StateID_Wait__13daEnHnSwich_c = 0x80B15D68;
	StateID_PushWait__13daEnHnSwich_c = 0x80B15E68;
	StateID_Carry__13dEnemyCarry_c = 0x80357B34;
	getCarryPos__7dAcPy_cFP7Point3dP7dAcPy_c = 0x8012DE80;

	returnFromCrowEffects5 = 0x809EED5C;
	...
	origFireSnakeIceballCollision = 0x809FB430;
	...
	returnFromFrogPenguinMove1 = 0x80A29E64;
	returnFromFrogPenguinMove2 = 0x80A27B98;
	...
	StateID_Wait__10daEnItem_c = 0x80B166B8;
	AddPhysics__10daEnItem_cFv = 0x80A28BB0;
	...
	returnFromBlooperNanny = 0x809A8F4C;
	returnFromTEX_BoomerangSettings = 0x809CE478;
	returnFromTEX_HammerSettings = 0x80A12414;
	returnFromPakkun_Projectile = 0x80029644;
	returnFromLakituSpawnArea = 0x80ABCB6C;
	returnFromLakituCloudBlock = 0x80A360B4;
	...
	doneWithDryBonesUpdateRate = 0x80A42A84;
	...
	doneWithDoubleCanonSpeed = 0x80A4E588;
	doneWithDoubleBulletSpeed = 0x80A4971C;
	...
	toadBlockEditsReturn = 0x809C3054;
	checkToadBlockNoToadReturn = 0x809C3A0C;
	player_set_15daEnBlockMain_cFii = 0x80022080;
	FUN_P1_800fd140 = 0x800FD030;

	StateID_Move__12daEnTeresa_c = 0x80B1B888;
	getTargetPos__12daEnTeresa_cFP7Point2d = 0x80AAFF60;
	origOnExecute__12daEnTeresa_cFv = 0x80AAEB40;
	origOnCreate__12daEnTeresa_cFv = 0x80AAE8B0;
	...
	returnToBigUrchinFireballReal = 0x80AB94F0;
	continueForNormalUrchinFireball = 0x80AB94C0;
	returnToBigUrchinIceballReal = 0x80AB9590;
	continueForNormalUrchinIceball = 0x80AB9588;
	returnForMawRayStar = 0x80AB9400;
	continueForNormalUrchinStar = 0x80AB93D8;
	continueUrchinTurn = 0x80AB90DC;
	continueUrchinNoTurn = 0x80AB90E0;
	continueUrchinOnCreate = 0x80AB8F68;
	StateID_Wait__12daEnUnizoo_c = 0x80B1BDF8;
	...
	returnFromDontResetLevelNode = 0x8092763C;
	...
	returnToOriginalAnimationCode3 = 0x809065D8;
	returnToOriginalAnimationCode4 = 0x809065CC;
	...
	FUN_80a28e00 = 0x80A28E20;
	FUN_80a28d10 = 0x80A28D30;
	FUN_80a29110 = 0x80A29130;
	FUN_80a286c0 = 0x80A286E0;
	...
	endState_StarMove__12daDarkStar_cFv = 0x80A2A2F0;*/
	checksSomething__13dStageActor_cFv = 0x80065110;
	EnItem_GetZPosToUse = 0x80A289E0;
	...
	returnFromWaterwaveIn1 = 0x80803398;
	returnFromWaterwaveIn2 = 0x80803920;
	returnFromWaterwaveIn3 = 0x80803514;

	returnFromWaterwaveOut1 = 0x808038F4;
	returnFromWaterwaveOut2 = 0x808034E8;
	returnFromWaterwaveOut3 = 0x8080336C;

	returnFromWatersplash1 = 0x8080311C;
	returnFromWatersplash2 = 0x80802F18;

	returnFromWater021 = 0x80803548;
	returnFromWater022 = 0x80803300;
	returnFromWater023 = 0x8080316C;

	returnFromFloatSplash = 0x80802704;
	...
	StateID_Flagdown__12daEnGlpole_c = 0x80B15510;
	...
	aLightWaterscen = 0x8098D578;
	aLightFirescene = 0x8098D590;
	aLightSabakusce = 0x8098D5A8;
	aLightKaigansce = 0x8098D5C4;
	aLightDaishizen = 0x8098D5E0;
	aLightYukidaysc = 0x8098D5FC;
	aLightSorascene = 0x8098D618;
	aLightIwabascen = 0x8098D630;
	aLightToridesce = 0x8098D648;
	aLightShiroscen = 0x8098D668;
	aLightObakescen = 0x8098D680;
	aLightKurayamic = 0x8098D698;
	aLightObakeouts = 0x8098D6B8;
	aLightShinkaisc = 0x8098D6D4;
	aLightSabakuchi = 0x8098D6F0;
	aLightKorichika = 0x8098D710;
	aLightFire2scen = 0x8098D730;
	aLightKoopascen = 0x8098D748;
	aLightFire3scen = 0x8098D760;
	aLightKumorisor = 0x8098D778;
	aLightToride2sc = 0x8098D798;

	aLightMainsce_0 = 0x8098D7B4;
	aLightChikasc_0 = 0x8098D7CC;
	aLightWatersc_0 = 0x8098D7E4;
	aLightFiresce_0 = 0x8098D7FC;
	aLightSabakus_0 = 0x8098D818;
	aLightKaigans_0 = 0x8098D830;
	aLightDaishiz_0 = 0x8098D848;
	aLightYukiday_0 = 0x8098D864;
	aLightSorasce_0 = 0x8098D880;
	aLightIwabasc_0 = 0x8098D898;
	aLightTorides_0 = 0x8098D8B0;
	aLightShirosc_0 = 0x8098D8C8;
	aLightObakesc_0 = 0x8098D8E0;
	aLightKurayam_0 = 0x8098D8F8;
	aLightObakeou_0 = 0x8098D918;
	aLightShinkai_0 = 0x8098D934;
	aLightSabakuc_0 = 0x8098D950;
	aLightKorichi_0 = 0x8098D970;
	aLightFire2sc_0 = 0x8098D98C;
	aLightKoopasc_0 = 0x8098D9A4;
	aLightFire3sc_0 = 0x8098D9BC;
	aLightKumoris_0 = 0x8098D9D4;
	aLightToride2_0 = 0x8098D9F0;

	aFogMainscene_b = 0x8098DA0C;
	aFogChikascene_ = 0x8098DA20;
	aFogWaterscene_ = 0x8098DA34;
	aFogFirescene_b = 0x8098DA48;
	aFogSabakuscene = 0x8098DA5C;
	aFogKaiganscene = 0x8098DA74;
	aFogDaishizensc = 0x8098DA90;
	aFogYukidayscen = 0x8098DAA8;
	aFogSorascene_b = 0x8098DAC0;
	aFogIwabascene_ = 0x8098DAD4;
	aFogToridescene = 0x8098DAE8;
	aFogShiroscene_ = 0x8098DB00;
	aFogObakescene_ = 0x8098DB14;
	aFogKurayamichi = 0x8098DB28;
	aFogObakeoutsce = 0x8098DB44;
	aFogShinkaiscen = 0x8098DB5C;
	aFogSabakuchika = 0x8098DB74;
	aFogKorichikasc = 0x8098DB90;
	aFogFire2scene_ = 0x8098DBA8;
	aFogKoopascene_ = 0x8098DBBC;
	aFogFire3scene_ = 0x8098DBD0;
	aFogKumorisoras = 0x8098DBE4;
	aFogToride2scen = 0x8098DC00;


	aRouteinfo_1 = 0x8098DD84;
	aCollectioncoincoursesort = 0x8098DD90;
	aCobcastle_1 = 0x8098DDAC;
	aCobcourse_0 = 0x8098DDB8;
	aCobkinokored_3 = 0x8098DC98;
	aCobkinoko1up_4 = 0x8098DCA8;
	aCobkinokosta_3 = 0x8098DCB8;
	aCobstart_0 = 0x8098DDC4;
	aCobanchor_0 = 0x8098DDD0;
	aCobtoride_1 = 0x8098DDDC;
	aCobghost_1 = 0x8098DDE8;
	aCobcannon_1 = 0x8098DDF4;
	aCobkoopaship_5 = 0x8098DCC8;
	aCharacter_s_12 = 0x8098DE00;
	aCobsurrender_0 = 0x8098DE10;
	aCobkinopio_1 = 0x8098DE20;
...
/* Mr Sun Related */
	...
	SI_Kinoko = 0x8098E064;
	SI_Fireflower = 0x8098E070;
	SI_Propeller = 0x8098E080;
	SI_Iceflower = 0x8098E090;
	...
	*/
	...
	daEnSnakeBlock_c__StateID_Move = 0x80B1B418;/*mi*/
	doSomethingElseWithTravelInfoBuffer__SnakeSubEx = 0x80AA7400;/*mi*/
	continueFromFirstLoop = 0x80AA7C30;
	continueFromNodeLoop = 0x80AA7CA0;
	continueFromSnakeBlockLoop3 = 0x80AA7474;
	continueFromSnakeBlockBackwards = 0x80AA7424;
	continueFromStoreIsLoopToR9_1 = 0x80AA85C0;
	continueFromStoreIsLoopToR9_2 = 0x80AA85D0;
	continueFromOtherDirectionsSpawn = 0x80AA78BC;
	continueFromAdjustSpawnPosition = 0x80AA6F58;
	continueFromRemoveSFX = 0x80AA85D0;
	continueFromDoNotMoveIfEvent = 0x80AA72E4;
	continueFromMakeTIBTwiceAsBig = 0x80AA7C38;
	continueFromCreateBackwardsData = 0x80AA8174;
	returnFromDoNotMoveIfEvent = 0x80AA7300;
	skipFromRemoveSFX = 0x80AA85FC;
	...
	doSomethingElseWithTravelInfoBuffer__10SnakeSubExFv = 0x80AA7400;/*mi*/

	instance__22dCourseSelectManager_c = 0x809A2390;
	StateID_KeyWait__22dCourseSelectManager_c = 0x809A2460;
	...
	doneWithSpawnShopAndLevelCredits = 0x8092707C;
	doneWithCheckForButtonPress = 0x80914C04;
	doneWithCheckForNewCSMBytes = 0x8092FAF8;

	continueCheckForNewCSMBytes = 0x8092FAE0;

	returnCheckForNewCSMBytes = 0x8092FB68;
