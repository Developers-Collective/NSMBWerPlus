...
This branch aims to have general compatibility with every aspect of the original game. NSMBWer+ is unfinished, please submit any issues or bugs to the issues page.
...
* Changes that break vanilla levels (such as the newer chest mod) have been removed.
* The Hammer suit has been removed.
* Randomized Yoshi colors have been removed.
* All Newer level sprites are present here, along with the ones they replace.
* 2-Castle hardcode fixes from AnotherSMBW have been removed.
